...
t_max_err set_hifreq(t_enrich *x, void *attr, long ac, t_atom *av);
t_max_err get_hifreq(t_enrich *x, void *attr, long *ac, t_atom **av);
t_max_err set_lofreq(t_enrich *x, void *attr, long ac, t_atom *av);
t_max_err get_lofreq(t_enrich *x, void *attr, long *ac, t_atom **av);
...
int C74_EXPORT main(void)
{
	...
	class_addmethod(c,(method)enrich_binstats,"binstats",0);
    
	CLASS_ATTR_LONG(c, "fftsize", 0, t_enrich, fftsize_attr);
	CLASS_ATTR_ACCESSORS(c, "fftsize", (method)get_fftsize, (method)set_fftsize);
	CLASS_ATTR_LABEL(c, "fftsize", 0, "FFT Size");
	
	CLASS_ATTR_LONG(c, "overlap", 0, t_enrich, overlap_attr);
    ...
    CLASS_ATTR_ORDER(c, "buffername",    0, "3");
    CLASS_ATTR_ORDER(c, "lofreq",    0, "4");
	CLASS_ATTR_ORDER(c, "hifreq",    0, "5");
