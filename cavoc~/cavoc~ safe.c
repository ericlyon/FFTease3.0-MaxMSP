...
int C74_EXPORT main(void)
{
	...
	class_addmethod(c,(method)cavoc_density,"density",A_FLOAT,0);
	class_addmethod(c,(method)cavoc_hold_time,"hold_time",A_FLOAT,0);
...
void *cavoc_new(t_symbol *msg, short argc, t_atom *argv)
{
	...
	x->hold_time = atom_getfloatarg(1,argc,argv); // convert from ms
