...
,
		"classnamespace" : "box",
		"rect" : [ 1449.0, 1171.0, 710.0, 537.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 257.0, 100.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 324.0, 178.0, 129.0, 22.0 ],
									"text" : "play~ fftz.ether.sound2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 552.0, 88.0, 249.0, 22.0 ],
									"text" : "buffer~ fftz.ether.sound2 i_am_the_edison.aif"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 105.0, 178.0, 129.0, 22.0 ],
									"text" : "play~ fftz.ether.sound1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 552.0, 55.0, 203.0, 22.0 ],
									"text" : "buffer~ fftz.ether.sound1 GigaEx4.aif"
								}
...
,
					"patching_rect" : [ 125.0, 311.0, 105.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 125.0, 257.0, 24.0, 24.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 220.5, 346.0, 206.0, 346.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 134.5, 346.0, 104.5, 346.0 ],
					"source" : [ "obj-1", 0 ]
				}
