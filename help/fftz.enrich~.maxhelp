...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 147.0, 106.0, 20.0 ],
					"text" : "play sound source"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 200.0, 194.0, 20.0 ],
					"text" : "see here for more function options:"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 284.0, 228.0, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 142.0, 70.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 284.0, 188.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 142.0, 121.0, 129.0, 22.0 ],
									"text" : "play~ fftz.enrich.sound"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 352.0, 70.0, 248.0, 22.0 ],
									"text" : "buffer~ fftz.enrich.sound ELDryGroove112.aif"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 151.5, 116.0, 293.5, 116.0 ],
									"order" : 0,
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"midpoints" : [ 293.5, 260.0, 337.5, 260.0, 337.5, 110.0, 151.5, 110.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 325.0, 180.0, 57.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 323.5, 403.576385000000073, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 325.0, 147.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 15.0, 246.0, 60.0 ],
					"text" : "fftz.enrich~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 259.999969000000021, 168.0, 21.0 ],
					"text" : "try drawing into this buffer:"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 323.5, 339.576354999999978, 138.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 384.576385000000016, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 363.576354999999978, 281.0, 21.0 ],
					"text" : "buffer must be mono and have 8192 samples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 33.0, 286.576354999999978, 256.0, 64.0 ],
					"setmode" : 4
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 1220.0, 1122.0, 749.0, 631.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 22.0, 67.0, 37.0, 23.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 22.0, 36.0, 65.0, 23.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 129.0, 116.0, 23.0 ],
									"text" : "sizeinsamps 8192"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 22.0, 153.0, 110.0, 23.0 ],
									"text" : "buffer~ richer 1 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 49.5, 109.0, 31.5, 109.0 ],
									"source" : [ "obj-12", 1 ]
								}
...
,
					"patching_rect" : [ 33.0, 226.999968999999993, 131.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 323.5, 297.0, 347.0, 23.0 ],
					"text" : "fftz.enrich~ @buffername wakki @lofreq 2. @hifreq 15000"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 333.0, 388.576369999999997, 359.0, 388.576369999999997 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Packages/FFTease3.0-MaxMSP-0cce254-release/javascript",
				"patcherrelativepath" : "../../../Max 8/Packages/FFTease3.0-MaxMSP-0cce254-release/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
