...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 168.0, 24.0, 24.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 105.0, 178.0, 165.0, 22.0 ],
									"text" : "play~ fftz.pvcompand.sound1"
								}
...
,
					"patching_rect" : [ 57.0, 207.0, 98.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 354.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.0, 207.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 57.0, 283.5, 136.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 72.0, 128.0, 21.0 ],
					"text" : "Spectral compander"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 12.0, 363.0, 60.0 ],
					"text" : "fftz.pvcompand~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 57.0, 250.0, 260.0, 23.0 ],
					"text" : "fftz.pvcompand~ @fftsize 4096 @overlap 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 207.0, 98.0, 21.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 323.5, 239.5, 307.5, 239.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 66.5, 335.75, 92.5, 335.75 ],
					"order" : 0,
					"source" : [ "obj-5", 0 ]
				}
