...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 50.0, 263.0, 36.0, 23.0 ],
					"text" : "*~ 4."
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 642.0, 1432.0, 1094.0, 462.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 324.0, 178.0, 127.0, 22.0 ],
									"text" : "play~ fftz.xsyn.sound2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 552.0, 88.0, 247.0, 22.0 ],
									"text" : "buffer~ fftz.xsyn.sound2 i_am_the_edison.aif"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 105.0, 178.0, 127.0, 22.0 ],
									"text" : "play~ fftz.xsyn.sound1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 552.0, 39.0, 255.0, 22.0 ],
									"text" : "buffer~ fftz.xsyn.sound1 EL_Butter_excerpt.aif"
								}
...
,
					"patching_rect" : [ 50.0, 175.0, 105.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 350.0, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 50.0, 293.0, 136.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.972076000000001, 76.0, 102.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.972076000000001, 16.0, 214.0, 60.0 ],
					"text" : "fftz.xsyn~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 50.0, 229.0, 220.0, 23.0 ],
					"text" : "fftz.xsyn~ @fftsize 1024 @overlap 8"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 59.5, 338.5, 84.5, 338.5 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 145.5, 213.0, 260.5, 213.0 ],
					"source" : [ "obj-5", 1 ]
				}
